...
INSERT INTO `employee_list` (`id`, `code`, `firstname`, `middlename`, `lastname`, `gender`, `email`, `department`, `position`, `password`, `generated_password`, `status`, `avatar`, `date_created`, `date_updated`, `proj_id`) VALUES
(1, '2022-0001', 'John', 'D', 'Smith', 'Male', 'jsmith@sample.com', 'IT Department', 'Web Developer', '5f92de022efaded7349590bf1fd332a6', 'zku8jn7x', 1, 'uploads/employee-1.png?v=1641966652', '2022-01-12 13:39:50', '2023-07-25 00:06:29', 1),
(2, '2022-0002', 'Claire', 'D', 'Blake', 'Male', 'cblake@sample.com', 'HR Department', 'Department Manager', '19e36ca1b52bb940291854cd5cd50328', 'j295eq4f', 1, 'uploads/employee-2.png?v=1641966673', '2022-01-12 13:46:11', '2023-07-25 00:06:33', 1),
(4, '2022-0003', 'Mark', 'Z', 'Cooper', 'Male', 'mcooper@sample.com', 'IT Department', 'Department Manager', 'c7162ff89c647f444fcaa5c635dac8c3', '', 1, 'uploads/employee-4.png?v=1641966950', '2022-01-12 13:55:50', '2022-01-12 14:20:24', 0),
(5, '2022-0004', 'Samantha', 'C', 'Miller', 'Female', 'sam23@sample.com', 'HR Department', 'Office Clerk', 'b7d631291e99998916529dcaf68f05dd', '21iqfz9v', 0, 'uploads/employee-5.png?v=1641967103', '2022-01-12 13:58:23', '2022-01-12 14:04:43', 0);

-- --------------------------------------------------------

--
-- Table structure for table `emp_proj_rel`
--

CREATE TABLE `emp_proj_rel` (
...
--
-- Dumping data for table `emp_proj_rel`
--

INSERT INTO `emp_proj_rel` (`id`, `emp_id`, `proj_id`) VALUES
(0, '2022-0001', 1),
(1, '2022-0001', 3),
(2, '2022-0002', 2),
(3, '2022-0002', 4),
...
--
-- Table structure for table `proj_worklist_rel`
--

CREATE TABLE `proj_worklist_rel` (
  `id` int(11) NOT NULL,
  `project_id` int(10) NOT NULL,
  `worklist_id` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `proj_worklist_rel`
--

INSERT INTO `proj_worklist_rel` (`id`, `project_id`, `worklist_id`) VALUES
(1, 3, 1),
(2, 2, 2),
(3, 4, 2),
(4, 1, 1),
...
(2, 'Administrator', NULL, 'Admin', 'admin', '123', 'uploads/avatar-1.png?v=1639468007', NULL, 1, 1, '2021-01-20 14:02:37', '2021-12-14 15:47:08'),
...
ALTER TABLE `employee_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `emp_code_index` (`code`);

--
-- Indexes for table `emp_proj_rel`
--
ALTER TABLE `emp_proj_rel`
...
--
-- Indexes for table `proj_worklist_rel`
--
ALTER TABLE `proj_worklist_rel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_work_id` (`worklist_id`);
...
--
-- AUTO_INCREMENT for table `proj_worklist_rel`
--
ALTER TABLE `proj_worklist_rel`
...
--
-- Constraints for table `emp_proj_rel`
--
ALTER TABLE `emp_proj_rel`
  ADD CONSTRAINT `fk_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `employee_list` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_proj_id` FOREIGN KEY (`proj_id`) REFERENCES `project_list` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `proj_worklist_rel`
--
ALTER TABLE `proj_worklist_rel`
  ADD CONSTRAINT `fk_work_id` FOREIGN KEY (`worklist_id`) REFERENCES `work_type_list` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
